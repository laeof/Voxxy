...
internal sealed class UploadPlaylistImageCommandHandler(
    IApplicationDbContext context,
    IOptions<ConnectionStringsOptions> connStrings,
    IUserContext userContext)
    : ICommandHandler<UploadPlaylistImageCommand, Guid>
{
    public async Task<Result<Guid>> Handle(UploadPlaylistImageCommand command, CancellationToken cancellationToken)
    {
